...
# TODO: Get rid of these list and load them from play_motion params as done in dmp_training.py
        self.joint_list = ['arm_1_joint', 'arm_2_joint', 'arm_3_joint',
    ...
    def robotTrajectoryFromPlanPoseBased(self, plan, downsample_freq=None):
...
#                 print "This is slice #" + str(slice_counter)
    ...
    def computeJointTrajFromCartesian(self, points, times, arm="arm_torso", downsample_freq=None):
    ...
    def computeIKsPose(self, poselist, times, arm="arm", downsample_freq=None):
        ...
        for pose, time in zip(poselist, times):
            ...
            if last_succesfull_ik_answer != None:
                ik_answer = self.getIkPose(pose,"arm", previous_state=last_succesfull_ik_answer.solution)
            else:
